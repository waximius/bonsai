 ...
 * @author TheDrydens
 */
public class OakTextureManager {
    ...
    private static void initTreeBark () {
        ...
        Texture tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/Bark128.jpg");
        mat.setTexture("ColorMap", tex);
        mat.setColor("Color", m_darkerWhite);
        m_lowBark = mat;
        
        mat = new Material(m_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/Bark256.jpg");
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/BarkBump256.jpg");
        ...
        mat = mat.clone();
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/Bark512.jpg");
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/BarkBump512.jpg");
        mat.setTexture("NormalMap", tex);
        /*tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/BarkSpec512.jpg");
        mat.setTexture("SpecularMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Oak/BarkDisp512.jpg");
    ...
    private static void initLeaves () {        
        Material mat = new Material(m_assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        Texture tex = m_assetManager.loadTexture("Textures/Tree/Leaves/Oak/Leaf128x4.png");
        mat.setTexture("ColorMap", tex);
        mat.setColor("Color", m_darkerWhite);
        ...
        mat = new Material(m_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        tex = m_assetManager.loadTexture("Textures/Tree/Leaves/Oak/Leaf256x4.png");
        //tex.setMinFilter(Texture.MinFilter.NearestNoMipMaps);
        //tex.setMagFilter(Texture.MagFilter.Nearest);
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Leaves/Oak/LeafBump256x4.png");
        //tex.setMinFilter(Texture.MinFilter.NearestNoMipMaps);
        //tex.setMagFilter(Texture.MagFilter.Nearest);
        mat.setTexture("NormalMap", tex);
        mat.setReceivesShadows(false);
