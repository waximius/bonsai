 ...
 * @author TheDrydens
 */
public class BonsaiBranchOak extends BonsaiBranch {
    ...
    private BonsaiTreeOak m_tree = null;
    
    private BonsaiBranchOak m_parentBranch = null;
    private BonsaiBranchOak m_leftBranch = null;
    private BonsaiBranchOak m_rightBranch = null;
    ...
    public BonsaiBranchOak (BonsaiTreeOak tree, BonsaiBranchOak parentBranch,
     ...
     */
    private float getRadius(BonsaiBranchOak branch, int r) {
        final int algo = 2;
        float retval = 0.0f;
     ...
     * @return A new branch
     */
    private BonsaiBranchOak generateBranch (int deltaT, int deltaP, boolean bud) {
        ...
        if (true == M_VARIABLE_BRANCH_LENGTH) {
            if (0.5 > Math.random ()) {
                double length = TREE_SCALE + (Math.random() * (TREE_SCALE * 0.30));
        ...
        return new BonsaiBranchOak (m_tree, this, 
            x1, y1, z1, t1, p1,
            stepSize, false, bud
        );
    }
    ...
    private BonsaiBranchOakGeometry m_geometry = null;
    ...
    public Node render (BonsaiApplication app, AssetManager assetManager, float percent, Node rootNode) {
        ...
        if (null == retval) {
            retval = new Node ();
            retval.setName(BonsaiBranchOak.TREE_ROOT_NAME);
        }

        Vector3f p0 = getVector3fStart();
        
        BonsaiBranchOak[] branches = {m_leftBranch, m_rightBranch};
        for (BonsaiBranchOak branch : branches) {
            if (null != branch) {
                ...
                Material treeBarkMat = OakTextureManager.getNewTreeBarkMaterial();
                ...
                Geometry geo = new BonsaiBranchOakGeometry(BonsaiBranchJmeInterface.BRANCH_CYLINDER_NAME, cyl, m_tree, this, branch);
                ...
                branch.setCylinderGeometry((BonsaiBranchOakGeometry)geo);
                ...
                geo = new Geometry(BonsaiBranchOak.BRANCH_TIP_NAME_START, sphere);
                ...
                geo = new Geometry(BonsaiBranchOak.BRANCH_TIP_NAME_END, sphere);
                ...
                if (true == m_isBud) {
                    ...
                    // Set our material
                    Material leafMat = OakTextureManager.getLeafMaterial();
                    //Material leafMat = OakTextureManager.getNewLeafMaterial();
     ...
     */
    public void setCylinderGeometry (BonsaiBranchOakGeometry geo) {
        m_geometry = geo;
    }
     ...
     */
    public BonsaiBranchOakGeometry getCylinderGeometry () {
        return m_geometry;
    }
}
