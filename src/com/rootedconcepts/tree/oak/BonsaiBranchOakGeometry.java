 ...
 * @author TheDrydens
 */
public class BonsaiBranchOakGeometry extends BonsaiBranchGeometry {
    ...
    private BonsaiBranchOak m_branchBase = null;
    private BonsaiBranchOak m_branchEnd = null;
    
    public BonsaiBranchOakGeometry (String name, Mesh mesh, BonsaiTreeOak tree, BonsaiBranchOak branchBase, BonsaiBranchOak branchEnd) {
    ...
    public void setBranchesHighlighted(boolean glowOn) {
        ...
        if (true == HIGHLIGHT_CHILDREN) {
            BonsaiBranchOak left = (BonsaiBranchOak)m_branchEnd.getLeftBranch();
            if ((null != left) && (null != left.getCylinderGeometry())) {
                left.getCylinderGeometry().setBranchesHighlighted(glowOn);
            }
            
            BonsaiBranchOak right = (BonsaiBranchOak)m_branchEnd.getRightBranch();
