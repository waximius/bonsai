 ...
 * @author TheDrydens
 */
public class BonsaiBranchMaple extends BonsaiBranch {
    ...
    private BonsaiBranchMaple m_parentBranch = null;
    private BonsaiBranchMaple m_leftBranch = null;
    private BonsaiBranchMaple m_rightBranch = null;
    ...
    public BonsaiBranchMaple (BonsaiTreeMaple tree, BonsaiBranchMaple parentBranch,
     ...
     */
    private float getRadius(BonsaiBranchMaple branch, int r) {
        final int algo = 2;
        float retval = 0.0f;
     ...
     * @return A new branch
     */
    private BonsaiBranchMaple generateBranch (int deltaT, int deltaP, boolean bud) {
        ...
        return new BonsaiBranchMaple (m_tree, this, 
            x1, y1, z1, t1, p1,
            stepSize, false, bud
        );
    }
    ...
    private BonsaiBranchMapleGeometry m_geometry = null;
    ...
    public Node render (BonsaiApplication app, AssetManager assetManager, float percent, Node rootNode) {
        ...
        if (null == retval) {
            retval = new Node ();
            retval.setName(BonsaiBranchMaple.TREE_ROOT_NAME);
        }

        Vector3f p0 = getVector3fStart();
        
        BonsaiBranchMaple[] branches = {m_leftBranch, m_rightBranch};
        for (BonsaiBranchMaple branch : branches) {
            if (null != branch) {
                ...
                Material treeBarkMat = MapleTextureManager.getNewTreeBarkMaterial();
                ...
                Geometry geo = new BonsaiBranchMapleGeometry(BonsaiBranchJmeInterface.BRANCH_CYLINDER_NAME, cyl, m_tree, this, branch);
                ...
                branch.setCylinderGeometry((BonsaiBranchMapleGeometry)geo);
                ...
                geo = new Geometry(BonsaiBranchMaple.BRANCH_TIP_NAME_START, sphere);
                ...
                geo = new Geometry(BonsaiBranchMaple.BRANCH_TIP_NAME_END, sphere);
                ...
                if (true == m_isBud) {
                    ...
                    // Set our material
                    Material leafMat = MapleTextureManager.getLeafMaterial();
                    //Material leafMat = MapleTextureManager.getNewLeafMaterial();
     ...
     */
    public void setCylinderGeometry (BonsaiBranchMapleGeometry geo) {
        m_geometry = geo;
    }
     ...
     */
    public BonsaiBranchMapleGeometry getCylinderGeometry () {
        return m_geometry;
    }
}
