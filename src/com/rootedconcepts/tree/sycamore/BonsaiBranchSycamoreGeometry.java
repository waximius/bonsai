 ...
 * @author TheDrydens
 */
public class BonsaiBranchSycamoreGeometry extends BonsaiBranchGeometry {
    ...
    private BonsaiBranchSycamore m_branchBase = null;
    private BonsaiBranchSycamore m_branchEnd = null;
    
    public BonsaiBranchSycamoreGeometry (String name, Mesh mesh, BonsaiTreeSycamore tree, BonsaiBranchSycamore branchBase, BonsaiBranchSycamore branchEnd) {
    ...
    public void setBranchesHighlighted(boolean glowOn) {
        ...
        if (true == HIGHLIGHT_CHILDREN) {
            BonsaiBranchSycamore left = (BonsaiBranchSycamore)m_branchEnd.getLeftBranch();
            if ((null != left) && (null != left.getCylinderGeometry())) {
                left.getCylinderGeometry().setBranchesHighlighted(glowOn);
            }
            
            BonsaiBranchSycamore right = (BonsaiBranchSycamore)m_branchEnd.getRightBranch();
