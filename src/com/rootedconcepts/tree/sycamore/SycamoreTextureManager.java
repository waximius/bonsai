 ...
 * @author TheDrydens
 */
public class SycamoreTextureManager {
    ...
    private static void initTreeBark () {
        ...
        Texture tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/Bark128.jpg");
        mat.setTexture("ColorMap", tex);
        mat.setColor("Color", m_darkerWhite);
        m_lowBark = mat;
        
        mat = new Material(m_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/Bark256.jpg");
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/BarkBump256.jpg");
        ...
        mat = mat.clone();
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/Bark512.jpg");
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/BarkBump512.jpg");
        mat.setTexture("NormalMap", tex);
        /*tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/BarkSpec512.jpg");
        mat.setTexture("SpecularMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/Sycamore/BarkDisp512.jpg");
    ...
    private static void initLeaves () {        
        Material mat = new Material(m_assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        Texture tex = m_assetManager.loadTexture("Textures/Tree/Leaves/Sycamore/Leaf128x4.png");
        mat.setTexture("ColorMap", tex);
        mat.setColor("Color", m_darkerWhite);
        ...
        mat = new Material(m_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        tex = m_assetManager.loadTexture("Textures/Tree/Leaves/Sycamore/Leaf256x4.png");
        //tex.setMinFilter(Texture.MinFilter.NearestNoMipMaps);
        //tex.setMagFilter(Texture.MagFilter.Nearest);
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Leaves/Sycamore/LeafBump256x4.png");
        //tex.setMinFilter(Texture.MinFilter.NearestNoMipMaps);
        //tex.setMagFilter(Texture.MagFilter.Nearest);
        mat.setTexture("NormalMap", tex);
        mat.setReceivesShadows(false);
