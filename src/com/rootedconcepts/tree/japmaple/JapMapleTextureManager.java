 ...
 * @author TheDrydens
 */
public class JapMapleTextureManager {
    ...
    private static void initTreeBark () {
        ...
        Texture tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/Bark128.jpg");
        mat.setTexture("ColorMap", tex);
        mat.setColor("Color", m_darkerWhite);
        m_lowBark = mat;
        
        mat = new Material(m_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/Bark256.jpg");
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/BarkBump256.jpg");
        ...
        mat = mat.clone();
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/Bark512.jpg");
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/BarkBump512.jpg");
        mat.setTexture("NormalMap", tex);
        /*tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/BarkSpec512.jpg");
        mat.setTexture("SpecularMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Bark/JapMaple/BarkDisp512.jpg");
    ...
    private static void initLeaves () {        
        Material mat = new Material(m_assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        Texture tex = m_assetManager.loadTexture("Textures/Tree/Leaves/JapMaple/Leaf128x4.png");
        mat.setTexture("ColorMap", tex);
        mat.setColor("Color", m_darkerWhite);
        ...
        mat = new Material(m_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        tex = m_assetManager.loadTexture("Textures/Tree/Leaves/JapMaple/Leaf256x4.png");
        tex.setMinFilter(Texture.MinFilter.NearestLinearMipMap);
        tex.setMagFilter(Texture.MagFilter.Bilinear);
        //tex.setAnisotropicFilter(16);
        mat.setTexture("DiffuseMap", tex);
        tex = m_assetManager.loadTexture("Textures/Tree/Leaves/JapMaple/LeafBump256x4.png");
        tex.setMinFilter(Texture.MinFilter.NearestLinearMipMap);
        tex.setMagFilter(Texture.MagFilter.Bilinear);
        //tex.setAnisotropicFilter(16);
        mat.setTexture("NormalMap", tex);
