 ...
 * @author TheDrydens
 */
public class BonsaiBranchJapMaple extends BonsaiBranch {
    ...
    private BonsaiBranchJapMaple m_parentBranch = null;
    private BonsaiBranchJapMaple m_leftBranch = null;
    private BonsaiBranchJapMaple m_rightBranch = null;
    ...
    public BonsaiBranchJapMaple (BonsaiTreeJapMaple tree, BonsaiBranchJapMaple parentBranch,
     ...
     */
    private float getRadius(BonsaiBranchJapMaple branch, int r) {
        final int algo = 2;
        float retval = 0.0f;
     ...
     * @return A new branch
     */
    private BonsaiBranchJapMaple generateBranch (int deltaT, int deltaP, boolean bud) {
        ...
        return new BonsaiBranchJapMaple (m_tree, this, 
            x1, y1, z1, t1, p1,
            stepSize, false, bud
        );
    }
    ...
    private BonsaiBranchJapMapleGeometry m_geometry = null;
    ...
    public Node render (BonsaiApplication app, AssetManager assetManager, float percent, Node rootNode) {
        ...
        if (null == retval) {
            retval = new Node ();
            retval.setName(BonsaiBranchJapMaple.TREE_ROOT_NAME);
        }

        Vector3f p0 = getVector3fStart();
        
        BonsaiBranchJapMaple[] branches = {m_leftBranch, m_rightBranch};
        for (BonsaiBranchJapMaple branch : branches) {
            if (null != branch) {
                ...
                Material treeBarkMat = JapMapleTextureManager.getNewTreeBarkMaterial();
                ...
                Geometry geo = new BonsaiBranchJapMapleGeometry(BonsaiBranchJmeInterface.BRANCH_CYLINDER_NAME, cyl, m_tree, this, branch);
                ...
                branch.setCylinderGeometry((BonsaiBranchJapMapleGeometry)geo);
                ...
                geo = new Geometry(BonsaiBranchJapMaple.BRANCH_TIP_NAME_START, sphere);
                ...
                geo = new Geometry(BonsaiBranchJapMaple.BRANCH_TIP_NAME_END, sphere);
                ...
                if (true == m_isBud) {
                    ...
                    leafCluster.setStartSize(baseRadius * 6);
                    leafCluster.setEndSize(baseRadius * 6);

                    // Set our material
                    Material leafMat = JapMapleTextureManager.getLeafMaterial();
                    //Material leafMat = JapMapleTextureManager.getNewLeafMaterial();
     ...
     */
    public void setCylinderGeometry (BonsaiBranchJapMapleGeometry geo) {
        m_geometry = geo;
    }
     ...
     */
    public BonsaiBranchJapMapleGeometry getCylinderGeometry () {
        return m_geometry;
    }
}
